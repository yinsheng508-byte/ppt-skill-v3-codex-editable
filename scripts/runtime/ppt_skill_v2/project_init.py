...
def create_project(project_name: str, output_root: str | Path) -> Path:
    ...
    (run_dir / "阶段2_图片版PPT" / "前5页试样").mkdir(parents=True, exist_ok=True)
    (run_dir / "阶段3_可编辑PPT" / "img").mkdir(parents=True, exist_ok=True)
    ...
    for dirname in [
        ...
        "阶段3/packets",
        "阶段3/no_text_background_prompts",
        "阶段3/no_text_background_results",
        "阶段3/briefs",
        "阶段3/image_api_batches",
        "阶段3/image_gen_batches",
        "阶段3/api_calls",
        "阶段3/image_gen_calls",
        "阶段3/api_outputs",
        "阶段3/image_gen_outputs",
        "阶段3/api_batch_runs",
        "阶段3/image_gen_runs",
        "阶段3/manifests",
        "阶段3/officecli",
        "阶段3/officecli/build",
        "阶段3/officecli/commands",
        "阶段3/officecli/readback",
        "阶段3/officecli/probe",
        "阶段3/inspect",
        "阶段3/render_review",
        "阶段3/render_review/triptych",
        "阶段3/ai_quality",
        "阶段3/logs",
        "阶段4/pdf_conversion",
        "阶段4/logs",
